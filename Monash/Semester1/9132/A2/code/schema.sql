...
ALTER TABLE Driver ADD CONSTRAINT chk_availibility CHECK ( availibility IN ('yes', 'no', 'sus')) ;
...
ALTER TABLE "audit" ADD CONSTRAINT audit_PK PRIMARY KEY ( log_id ) ;
...
ALTER TABLE booking ADD CONSTRAINT booking_PK PRIMARY KEY ( Driver_driver_id, official_olympic_id, registration_rego, intend_start_location_id,
...
ALTER TABLE vehicle_action_records ADD CONSTRAINT vehicle_action_records_PK PRIMARY KEY ( vehicle_vin, action_action_id ) ;
...
ALTER TABLE booking ADD CONSTRAINT booking_location_FK FOREIGN KEY ( intend_start_location_id ) REFERENCES location ( location_id ) ;


ALTER TABLE booking ADD CONSTRAINT booking_location_FKv1 FOREIGN KEY ( intend_end_location_id ) REFERENCES location ( location_id ) ;


ALTER TABLE booking ADD CONSTRAINT booking_official_FK FOREIGN KEY ( official_olympic_id ) REFERENCES official ( olympic_id ) ;
...
ALTER TABLE trip ADD CONSTRAINT trip_booking_FK FOREIGN KEY ( booking_driver_id, booking_olympic_id, booking_rego, booking_intend_start_lid,
...
ALTER TABLE trip ADD CONSTRAINT trip_location_FK FOREIGN KEY ( location_location_id2 ) REFERENCES location ( location_id ) ;


ALTER TABLE vehicle ADD CONSTRAINT vehicle_Colour_FK FOREIGN KEY ( Colour_colour_id ) REFERENCES Colour ( colour_id ) ;


ALTER TABLE vehicle_action_records ADD CONSTRAINT vehicle_action_FK FOREIGN KEY ( action_action_id ) REFERENCES action ( action_id ) ;
